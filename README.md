...
|[hackingthe.cloud](https://hackingthe.cloud) | Hacking the cloud is an encyclopedia of the attacks/tactics/techniques that offensive security professionals can use on their next cloud exploitation adventure.
|[cloud.hacktricks](https://cloud.hacktricks.xyz/welcome/readme)  |
